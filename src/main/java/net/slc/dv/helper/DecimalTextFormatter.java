...
public class DecimalTextFormatter extends TextFormatter<Number> {
    ...
    public DecimalTextFormatter(int minDecimals, int maxDecimals, double minValue, double maxValue) {
        super(getStringConverter(minDecimals, maxDecimals), 0, getUnaryOperator(minDecimals, true, -1, minValue, maxValue));
        ...
        return new UnaryOperator<TextFormatter.Change>() {
            ...
            public TextFormatter.Change apply(TextFormatter.Change change) {
                ...
                if (object == null || parsePosition.getIndex() < change.getControlNewText().length()) {
                    ...
                    double newValue = Double.parseDouble(change.getControlNewText());
