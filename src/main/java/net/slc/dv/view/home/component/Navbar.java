...
public class Navbar extends HBox {
	...
	public HBox createRightNav(){
		...
		return HBoxBuilder.create()
				.addChildren(themeSwitchButton, plusButton, createUserButton())
	...
	private ContextMenu createPlusMenu() {
		this.createClass = MenuItemBuilder.create()
				...
				.setStyleClass("item")
				.setOnAction(e -> new CreateClass(stage))
				.build();
		this.joinClass = MenuItemBuilder.create()
				.setText("Join Class")
				.setStyleClass("item")
				.setOnAction(e -> new JoinClass(stage))
				.build();
	...
	private Button createUserButton() {
		...
		if (loggedUser != null) {
			...
			userImageView = ImageViewBuilder.create()
					.setImage(Objects.requireNonNullElseGet(userImage, () -> new Image("file:resources/icons/user.png")))
					.setFitWidth(40)
					.setFitHeight(40)
					.setPreserveRatio(true)
					.build();
